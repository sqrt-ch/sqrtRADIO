...
- Python packages: `sounddevice`, `requests` (all other dependencies are Python standard library)
...
- Python-Pakete: `sounddevice`, `requests` (alle übrigen Abhängigkeiten gehören zur Python-Standardbibliothek)
